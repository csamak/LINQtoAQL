...
namespace LinqToAql.QueryBuilding
{
    internal class QueryBuilder
    {
        ...
        ///     or &gt; in variable identifiers. Rather than modifying the identifier generation and introducing more complexity in
        ///     this project, the below is a workaround to remove the special characters. Later to avoid issues in corner cases,
        ///     this should be moved to the member expression visitor or custom identifier generation should be used.
        /// </summary>
