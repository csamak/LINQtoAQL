...
namespace LINQToAQL.Similarity
{
    ...
    /// </summary>
    /// <remarks>See http://asterixdb.ics.uci.edu/documentation/aql/functions.html for more information about individual functions.</remarks>
    public static class EditDistanceExtensions
    {
        ...
        /// <remarks>The <see cref="IEnumerable{T}"/> of <typeparamref name="T"/> is evaluated as the <c>OrderedList</c> referenced in the AQL documentation</remarks>
        /// <returns>The edit distance</returns>
